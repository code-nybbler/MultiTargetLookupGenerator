...
namespace MultiTargetLookupGenerator
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "Multi Target Lookup Generator"),
        ExportMetadata("Description", "Allows users to create multi target lookups"),
    ...
    public class MultiTargetLookupGenerator : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new MultiTargetLookupGeneratorControl();
        }

        /// <summary>
        /// Constructor 
        /// </summary>
        public MultiTargetLookupGenerator()
        {
